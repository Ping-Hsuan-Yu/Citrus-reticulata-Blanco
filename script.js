...
const handleOnChange = () => {
  ...
  if (!isNaN(orangeValue)) {
    document.getElementById("orange-total").innerText = (
      Number(orangeValue) * 400
    ).toLocaleString();
...
const copyText = (element) => {
  ...
  try {
    ...
    Toastify({
      ...
      style: {
        background:
          "linear-gradient(90deg, rgba(255,165,0,0.7) 0%, rgba(255,72,0,0.7) 100%)",
      },
    }).showToast();
  } catch (err) {
